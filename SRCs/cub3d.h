...
/*   Updated: 2020/11/12 16:34:56 by abdait-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void                        ft_start_drawing(int dr_s, int dr_e, int x, t_cub *cub);
int                         ft_start_parsing(int fd, t_cub *cub);
void                        ft_init_vars(t_cub *cub);
int                         ft_init_game(t_cub *cub);
int                         ft_set_texs(t_cub *cub);
void                        ft_rotate_right(double *old_dir_x, double *old_plan_x, t_cub *cub);
